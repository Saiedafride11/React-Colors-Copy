        ...
        <div className="banner" id="home">
            ...
            <div className="container">
                ...
                <HashLink className="btn btn-primary " to="/home#text-colors" role="button">Try <span
                        className="main-color fw-bolder">Colors Copy.</span></HashLink>
                {/* Modal */}
                ...
                <Modal show={show} onHide={handleClose} animation={false}>
                    ...
                    <h5><span className="fw-bolder">Learn to use Colors Copy.</span> </h5>
                    </Modal.Header>
                    <Modal.Body>
                        <span className="main-color fw-bolder">Colors Copy.</span> is super fast & easy to use.
                        <hr />
